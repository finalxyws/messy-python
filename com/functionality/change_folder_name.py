...
# list all the folders and files name under one directory and replace '-' and blank if there is with '_' in the folder name
import os
import sys
import re
